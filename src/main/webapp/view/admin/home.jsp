...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<c:url value="/template/shop_template" var="url"></c:url>rl>
<!DOCTYPE html>
<html lang="vi">
  <head>
                ...
                <div class="d-flex">
                  <div class="dropdown mr-1 ml-md-auto">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                      <a class="dropdown-item" href="${pageContext.request.contextPath}/add-product">Thêm Sản Phẩm</a>
				...
				<div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                		<div class="block-4 text-center border">
                  			...
                  			<div class="block-4-text p-4">
                    			...
                    			<a href="${pageContext.request.contextPath}/product-delete?id=${p.id}" class="btn btn-primary btn-sm">X</a>
                  			</div>
                		</div>
              	</div>
				</c:forEach>
